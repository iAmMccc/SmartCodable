...
感谢以下贡献者通过 Pull Request 为本项目带来的改进与完善（按时间排序

| 贡献者                                                  | PR   | 贡献内容（50字）               |
| ------------------------------------------------------- | ---- | ------------------------------ |
| [cba023](https://github.com/cba023)                     | -    | SmartModeler 工具核心代码。    |
| [dadadong](https://github.com/dadadong)                 | -    | `@SmartHexColor` 优化          |
| [dgpGitH](https://github.com/dgpGitH)                   | #20  | Add support for designatedPath |
| [dadadong](https://github.com/dadadong)                 | #71  | 优化文档                       |
| **[Miles-Matheson](https://github.com/Miles-Matheson)** | #3   | add SPM                        |
...
> 提交 PR 时，请顺便把你的贡献记录新增到本章节列表中，以便大家看到你的贡献 ✨
